...
Next, go to `Edit`->`Preferences`, and check `Enable XML editing`, then click the `Close` button. If you have an older version, edit the XML file on /etc/libvirt/qemu/NAME_OF_THE_VM.xml
